...
const introTl = () => {
    ...
    tl.fromTo(introTitle, .7, {marginTop: 100}, {marginTop: -75, ease: Power2.easeInOut}, '-=.3');
    ...
    tl.to(main, 0, {background: '#f1f1f1' }, '-=.5');
...
const mainTl = () => {
    ...
    tl.to(main, 0, {background: '#080808' });
    ...
    tl.to(logoH1After, 1, {width: '0%', transform: 'skew(30deg)', ease: Power2.easeInOut}, '-=.2' );
    tl.to(bottomAfter, 1, {width: '0%', ease: Power2.easeInOut}, '-=.7' );
    tl.to(menuAfter, 1, {width: '0%', transform: 'skew(30deg)', ease: Power2.easeInOut}, '-=.7');
    tl.to(menuItemsAfter, 1.3, {width: '0%', transform: 'skew(30deg)', ease: Power2.easeInOut}, '-=1.5' );
    tl.to(scrollAfter, 1.3, {height: '0%', ease: Power2.easeInOut}, '-=1' );
    tl.to(contentH1After, 1.6, {width: '0%', transform: 'skew(30deg', ease: Power2.easeInOut}, '-=2' );
    tl.to(contentH4After, 1.6, {width: '0%', transform: 'skew(0deg', ease: Power2.easeInOut}, '-=2' );
    tl.to(contentRightAfter, 2, {width: '0%', ease: Power2.easeInOut}, '-=2' );
